    ...
    <div id='sign-back' className='w-full h-screen  '>
        <div className='sigcard w-[90%] h-fit lg:w-[25%] p-5 lg:p-10 lg:h-fit bg-[#afa5a522] rounded-[20px] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] '>
            ...
            <form className='w-full mt-5 flex flex-col justify-center'>
                <input className='w-[290px] lg:w-[350px] h-[55px] rounded-full mt-10 mx-auto p-5 text-2xl ' type="text" placeholder='Username'/>
                <input className='w-[290px] lg:w-[350px] h-[55px] rounded-full mt-10 mx-auto p-5 text-2xl' type="email" placeholder='Email'/>
                <input className='w-[290px] lg:w-[350px] h-[55px] rounded-full mt-10 mx-auto p-5 text-2xl' type="password" placeholder='Password' />
